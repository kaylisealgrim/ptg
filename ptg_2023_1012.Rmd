...
df_numeric$clust3 <- relevel(df_numeric$clust3, ref = "1")
...
df_relabel <- data1
df_wide <- df_numeric %>%
  pivot_wider(names_from = wave, values_from = c(clust3), id_cols = SUBJID)
...
data_merged <- data_merged[!is.na(data_merged$ss1.Age), ]
data_merged <- data_merged  %>% rename(clust3 = `1`)
df_wide_2 <- df_numeric %>%
  pivot_wider(names_from = wave, 
              values_from = c(clust3, etv1, pts1, Gender, ss1.RaceBlack, ss1.RaceHispanic, ss1.RaceAsian, ss1.RaceMixed, ss1.RaceOther, ptg),
              id_cols = SUBJID)
              
df_wide_2 <- df_wide_2 %>% 
  rename(clust3 = clust3_1, etv1 = etv1_1, pts1 = pts1_1, Gender = Gender_1, ss1.RaceBlack = ss1.RaceBlack_1, ss1.RaceHispanic = ss1.RaceHispanic_1, ss1.RaceAsian = ss1.RaceAsian_1, ss1.RaceMixed = ss1.RaceMixed_1, ss1.RaceOther = ss1.RaceOther_1, ptg = ptg_1)

df_wide_2 <- df_wide_2 %>% 
  select(clust3, etv1, pts1, Gender, ss1.RaceBlack, ss1.RaceHispanic, ss1.RaceAsian, ss1.RaceMixed, ss1.RaceOther, ptg)
...
wide_model <- multinom(clust3 ~ etv1 + pts1 + Gender + ss1.RaceBlack + ss1.RaceHispanic + ss1.RaceAsian + ss1.RaceMixed + ss1.RaceOther, data = df_wide_2)
summary(fullmodel)
summary(wide_model)
exp(coef(fullmodel))
```
