...
m3pts_full <- lcmm::hlme(ptg ~ wave + pts1 + ss1.RaceBlack + ss1.RaceHispanic + ss1.RaceAsian + ss1.RaceMixed + ss1.RaceOther, mixture = ~wave + pts1 + ss1.RaceBlack + ss1.RaceHispanic + ss1.RaceAsian + ss1.RaceMixed + ss1.RaceOther, subject='SUBJID', classmb = ~ pts1, ng = 3, data = df_numeric, B = lcga3_ctrls)
...
# 29.90% in Class 1; 27.32% in Class 2; 42.78% in Class 3 ; Class 1 = Low; Class 2 = High; Class 3 = Medium
